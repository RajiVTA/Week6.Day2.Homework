...
public class TC001_CreateNewCallerTestNG  extends TC004_BaseClass{
	...
	// 3.1 -------Enter Callers in filter navigator and press enter -------------------
			...
			driver.findElement(By.xpath("//input[@id='sys_user.first_name']")).sendKeys("Kavin"); //FirstName
			
			String lName="Velmurugan";
			WebElement lastName = driver.findElement(By.xpath("//input[@name='sys_user.last_name']"));
			lastName.sendKeys("Velmurugan"); //LastName
			...
			driver.findElement(By.xpath("//input[@name='sys_user.mobile_phone']")).sendKeys("343434");  //Mobile
			Thread.sleep(8000);
